# Módulo UML – Modelagem Dinâmica: Diagrama de Estados
...
<p style="text-align:center">Imagem 1: Diagrama de Estados Completo</p>

![Diagrama de Estados – Visão Completa](./img/paginaToda.png)

Fonte: [Quadro de Participações](#_41-quadro-de-participações)
...
<p style="text-align:center">Imagem 2: Diagrama de Estados - Parte 1</p>
...
<p style="text-align:center">Imagem 3: Diagrama de Estados - Parte 2</p>
...
<p style="text-align:center">Imagem 4: Diagrama de Estados - Parte 3</p>
...
### 3.1. Por que Diagrama de Estados?
...
| Gabriel Sampaio Fae             | Elaboração conjunta do diagrama em [reunião via Microsoft Teams](https://unbarqdsw2026-1-turma02.github.io/2026.01-T02-G2_OrganizeSeuGrupo_Entrega_02/#/Modelagem/2.5.3.DocumentacaoReunioes?id=ata-de-reunião-06) e elaboração/documentação da modelagem no [GitHub](https://github.com/UnBArqDsw2026-1-Turma02/2026.01-T02-G2_OrganizeSeuGrupo_Entrega_02/commit/256a811ec79e9616baeeca797fc36babd65dd50a) |
...
<p style="text-align:center">Imagem 5: Rascunho do Diagrama</p>

![Rascunho](./img/rascunho.png)

<p align="center"><b>Fonte: </b>Autoria de <a href="https://github.com/faehzin">Gabriel Fae</a></p>
...
|--------|------------|------------------------------------|------------------| --------|
| 1.0    | 23/04/2026 | Criação do documento e do diagrama | [Gabriel Fae](https://github.com/faehzin) | [Mayara Marques](https://github.com/faehzin) |
| 1.1    | 24/04/2026 | Adição de link da ata de reunião | [Eduardo de Pina](https://github.com/eduardodpms) | [Mayara Marques](https://github.com/maymarquee) |