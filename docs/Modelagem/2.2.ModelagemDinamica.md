...
| Membro | Contribuição |
|--------|-------------|
| Todos os membros | Elaboração conjunta do diagrama em reunião via Microsoft Teams |

> A ata da reunião de elaboração do diagrama pode ser encontrada em: [Ata da Reunião](./ata-reuniao1.md)
...
|--------|------------|------------------------------------|------------------| --------|
| 1.0    | 23/04/2026 | Criação do documento e do diagrama | Gabriel Fae |