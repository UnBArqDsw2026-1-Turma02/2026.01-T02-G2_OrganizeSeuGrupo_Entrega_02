...
O diagrama de casos de uso apresenta as funcionalidades do sistema sob a perspectiva dos atores externos,
evidenciando quem interage com a aplicação e quais objetivos podem ser alcançados em cada interação.
Esse tipo de modelagem ajuda a alinhar os requisitos funcionais com as necessidades reais dos usuários.
...
![Diagrama de Casos de Uso](./img/CasosDeUso-OrganizeSeuGrupo.drawio.svg)
...
| 1.2   | 24/04/2026 | Inserção e documentação do diagrama de casos de uso   | [Mayara Marques](https://github.com/maymarquee)               | [Gabriel Fae](https://github.com/camilasilvac)         |